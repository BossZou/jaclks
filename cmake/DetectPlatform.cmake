...
if(CMAKE_SYSTEM_NAME STREQUAL "Windows")
  set(PLATFORM_WINDOWS
      ON
      CACHE INTERNAL "Targeting Windows platform")
  set(PLATFORM_NAME "windows")
elseif(CMAKE_SYSTEM_NAME STREQUAL "Linux")
  set(PLATFORM_LINUX
      ON
      CACHE INTERNAL "Targeting Linux platform")
  set(PLATFORM_NAME "linux")
elseif(CMAKE_SYSTEM_NAME STREQUAL "Darwin")
  set(PLATFORM_MACOS
      ON
      CACHE INTERNAL "Targeting macOS platform")
...
# Detect CPU Architecture if(CMAKE_SIZEOF_VOID_P EQUAL 8) set(ARCH_64BIT ON
# CACHE INTERNAL "64-bit architecture") set(ARCH_NAME "x64") else()
# set(ARCH_32BIT ON CACHE INTERNAL "32-bit architecture") set(ARCH_NAME "x86")
# endif()
...
set(PLATFORM_ARCH
    ...
    CACHE STRING "Platform-architecture identifier")
